...
<form class="shipping_calculator" action="<?php echo esc_url( WC()->cart->get_cart_url() ); ?>" method="post">
	...
	<h2><a href="#" class="btn btn-info btn-block shipping-calculator-button"><?php _e( 'Calculate Shipping', 'woocommerce' ); ?>&nbsp;<i class="fa fa-truck fa-fw"></i></a></h2>
	...
	<section class="shipping-calculator-form">
		...
		<button type="submit" name="calc_shipping" value="1" class="btn btn-success"><?php _e( 'Update Totals', 'woocommerce' ); ?></button>
