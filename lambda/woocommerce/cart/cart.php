			...
			<?php wc_print_notices(); ?>
				<form action="<?php echo esc_url( WC()->cart->get_cart_url() ); ?>" method="post">
					...
					<div class="table-responsive">
						<table class="shop_table cart table element-bottom-20" cellspacing="0">
							<thead>
								<tr>
					...
					<div class="row">
						...
						<div class="col-md-3 element-bottom-20">
							<button type="submit" class="btn btn-info btn-block" name="update_cart" value="<?php _e( 'Update Cart', 'woocommerce' ); ?>">
